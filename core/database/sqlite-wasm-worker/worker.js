/**
 * Web Worker that implements the androidx.sqlite WebWorkerSQLiteDriver protocol
 * using official SQLite WASM with OPFS persistence.
 *
 * Adapted from https://github.com/danysantiago/room-web-demo (Apache-2.0).
 */
